...
import { UserId, deleteUserById } from "../store/users/user-slice";
...
export default function ListOfUsers() {
    ...
    const handleDelete = (id: UserId): void => {
                    ...
                    {users.map((item) => (
                        <TableRow key={item.id}>
                            ...
                            <TableCell>
                                ...
                                <button aria-label="remove element" type="button" onClick={() => { handleDelete(item.id) }}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
